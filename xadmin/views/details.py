...
class DetailsAdminView(ModelAdminView):
    ...
    def get_context(self):
        ...
        context = super(DetailsAdminView, self).get_context()
        context.update(new_context)
        return context

    @filter_hook
    def get_breadcrumb(self):
        bcs = super(DetailsAdminView, self).get_breadcrumb()
    ...
    @filter_hook
    def get_media(self):
        return super(DetailsAdminView, self).get_media() + self.form_obj.media + \
...
class PrintAdminView(ModelAdminView):
    ...
    def init_request(self, object_id, *args, **kwargs):
        print('PrintAdminView init_request')
        self.obj = self.get_object(unquote(object_id))
    ...
    def get_context(self):
        ...
        context = super(PrintAdminView, self).get_context()
        context.update(new_context)
        return context

    @filter_hook
    def get_breadcrumb(self):
        bcs = super(PrintAdminView, self).get_breadcrumb()
        item = {'title': force_text(self.obj)}
        if self.has_view_permission():
            item['url'] = self.model_admin_url('detail', self.obj.pk)
        bcs.append(item)
    ...
    @filter_hook
    def get_media(self):
        return super(PrintAdminView, self).get_media() + self.form_obj.media + \
            self.vendor('xadmin.page.form.js', 'xadmin.form.css')
...
class Print1AdminView(ModelAdminView):
    ...
    def init_request(self, object_id, *args, **kwargs):
        print('Print1AdminView init_request')
        self.obj = self.get_object(unquote(object_id))
    ...
    def get_context(self):
        ...
        context = super(Print1AdminView, self).get_context()
        context.update(new_context)
        return context

    @filter_hook
    def get_breadcrumb(self):
        bcs = super(Print1AdminView, self).get_breadcrumb()
        item = {'title': force_text(self.obj)}
        if self.has_view_permission():
            item['url'] = self.model_admin_url('detail', self.obj.pk)
        bcs.append(item)
    ...
    @filter_hook
    def get_media(self):
        return super(Print1AdminView, self).get_media() + self.form_obj.media + \
            self.vendor('xadmin.page.form.js', 'xadmin.form.css')
    ...
    def get_response(self, *args, **kwargs):
        ...
        print('context',context)
        response = TemplateResponse(self.request,
                                    self.get_template_list('views/print_card1.html'),
                                    context)
        return response
